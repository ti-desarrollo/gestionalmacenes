...
if (isset($_REQUEST, $_SESSION)) {
    ...
    switch ($_REQUEST['task']) {
        ...
        case 1:
            ...
            echo json_encode($soldadura->listarPesajes($_SESSION['ga-idSedeUsu']));
            //print_r($soldadura);
            break;

        case 2:
            // Listar las sobrantes
            echo json_encode($soldadura->listarSobrantes($_SESSION['ga-idSedeUsu']));
            break;

        case 3:
            // Registrar Pesaje de soldadura
            echo json_encode($soldadura->registrarSoldadura($_POST['sede'] ?? $_SESSION['ga-idSedeUsu'], $_POST['txtCantidad'], $_POST['descripcion'], $_POST['empaque'], $_POST['nmbKGTotal'], $_POST['txtFecha'], $_SESSION['ga-naUsu']));
            break;
            
        case 4:
            // Registrar sobrante de soldadura
            echo json_encode($soldadura->registrarSobrantes($_POST['sede'] ?? $_SESSION['ga-idSedeUsu'], $_POST['cantidad'], $_POST['descripcion'], $_POST['nmbKGTotalS'], $_POST['fecha'], $_SESSION['ga-naUsu']));
            break;
        ...
        case 6:
            ...
            echo json_encode($soldadura->notificadorSoldadura($_POST['sede'] ?? $_SESSION['ga-idSedeUsu']));
            break;

        case 7:
            // Lista de conformidad de soldadura sobrante
            echo json_encode($soldadura->listaConformidad($_SESSION['ga-idSedeUsu']));
            break;

        case 8:
            // Lista detalle de conformidad de soldadura sobrante
            echo json_encode($soldadura->listaDetalleConformidad($_SESSION['ga-idSedeUsu']));
            break;

        case 9:
            // Dar conformidad de soldadura sobrante
            echo json_encode($soldadura->confirmar($_POST['codigo'], $_POST['sede'] ?? $_SESSION['ga-idSedeUsu'],  $_POST["operacion"], $_POST["estado"], $_POST["txtComentarios"], $_POST['txtFC']));
            break;
