                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-2 col-xxl-2 mb-3">
                                <label for="txtNumGuia_SolicitudTraslado">N° Guía</label>
                            ...
                            <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-2 col-xxl-2 mb-3">
                                ...
                                <select class="form-control form-control-sm" id="selConformidad_SolicitudTraslado" onchange="habilitarComentarios()">
